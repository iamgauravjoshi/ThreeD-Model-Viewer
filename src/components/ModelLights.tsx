...
import {IModelLightProps} from "../model/ModelViewer";
...
const ModelLights: React.FC = ({ModelLightProps, setModelLightProps}: IModelLightProps) => {
        ...
        <>
            <div className={'flex flex-col gap-2'}>
                ...
                <div className={'flex flex-col gap-1 mb-4'}>
                    ...
                    <select
                        id="lights"
                        onChange={(e:any)=>setModelLightProps({...ModelLightProps, name: e.target.value})}
                    ...
                    <div className='col-span-2'>
                        ...
                        <input
                            id={'light-intensity'}
                            type={'number'}
                            defaultValue={ModelLightProps.intensity}
                            onChange={(e: any) => setModelLightProps({...ModelLightProps, intensity: e.target.value})}
